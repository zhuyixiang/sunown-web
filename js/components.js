/**
 * ============================================
 * Shared components - navigation and footer
 * ============================================
 */
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <ul class=\"nav-menu\">
                ...
                <li><a href=\"${base}hot-sales.html\" class=\"nav-link \">Hot Sales</a></li>
                <li><a href=\"${base}products/inventory.html\" class=\"nav-link \">Inventory</a></li>
                ...
                <li><a href=\"${base}manufacturing.html\" class=\"nav-link \">Our Facilities</a></li>
                <li><a href=\"${base}services.html\" class=\"nav-link \">Service</a></li>
                <li><a href=\"${base}about.html\" class=\"nav-link \">About US</a></li>
                <li><a href=\"${base}contact.html\" class=\"nav-link \">Contact US</a></li>
            </ul>
        </div>
    </nav>
    `;
    ...
    <footer class=\"footer\">
        <div class=\"container\">
            ...
            <div class=\"footer-col\">
                <h6>Products</h6>
                <ul>
                    <li><a href=\"${base}products/inventory.html\">Inventory</a></li>
...
<!--                    <a href=\"https://x.com/kongqianjuehou\" target=\"_blank\" class=\"social-icon\"><i class=\"bi bi-twitter-x\"></i></a>-->
            ...
            <hr>
            <p class=\"copyright\">Copyright &copy; 2025 Nutra Queen Inc | All Rights Reserved</p>
        </div>
    </footer>
    `;
